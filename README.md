...
- **Repo Kümesi:** `openfinance-open-data`
- **Bounded Context:** `open-finance`
- **Ana Capability:** Open products catalog and reference datasets
- **Dönüşüm Wave:** 1
...
- `Open products catalog and reference datasets` kapsamında kod, sözleşme, test, runbook ve release artefaktları.
